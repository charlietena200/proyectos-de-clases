...
namespace Proyecto
{
    public static class BD
    {
        public static void Insertar(EdoCuenta e)
        {
            ...
            string sqlInsert = "INSERT INTO DatosGenerales (folio, fechaEmision, nombre, apPat, apMat, edad, telefono, direccion, fechaRegistro, noCliente, noHabitacion, subTotal, total) VALUES (";
            sqlInsert += e.Folio + ", ";
        ...
        public static void Buscar(string folioABuscar)
        {
            ...
            string sql = "Select * from DatosGenerales WHERE folio LIKE ";
            sql += folioABuscar;
        ...
        public static void Borrar(string folioABuscar)
        {
            ...
            string sql = "DELETE * from DatosGenerales WHERE folio LIKE ";
            sql += folioABuscar;
            //Console.WriteLine(sql);
            OleDbDataAdapter adapter = new OleDbDataAdapter(sql, connstring);
